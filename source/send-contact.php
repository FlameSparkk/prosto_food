...
if(isset($_POST['phone'])) {
  ...
  try {
      ...
      // Создание клиента
      $subdomain = 'rutar';            // Поддомен в амо срм
      $login     = 'rutar97@gmail.com';            // Логин в амо срм
      $apikey    = 'da536c5ffb54b7f76f804577ab954c68a8d8202c';            // api ключ
      ...
      $contact['linked_leads_id'] = [(int)$id];
        ...
        $contact->addCustomField(78571, [
            [$_POST['phone'], 'MOB'],
        ]);

        $contact->addCustomField(78573, [
            [$_POST['email'], 'OTHER'],
        ]);
